      ...
      <div class="relative flex flex-col md:flex-row items-center gap-8">
        ...
        <div class="flex-1 text-center md:text-left">
          ...
          <div class="grid grid-cols-1 sm:grid-cols-2 gap-3 text-slate-600 dark:text-slate-400 max-w-2xl mx-auto md:mx-0">
            <span class="flex items-center gap-2 px-3 py-1.5 bg-slate-100 dark:bg-slate-800 rounded-full text-sm border border-transparent hover:border-primary-200 dark:hover:border-primary-800 transition-colors">
            ...
            <span class="flex items-center gap-2 px-3 py-1.5 bg-slate-100 dark:bg-slate-800 rounded-full text-sm border border-transparent hover:border-primary-200 dark:hover:border-primary-800 transition-colors">
              <svg class="w-4 h-4 text-primary-500" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path d="M21 12a9 9 0 01-9 9m9-9a9 9 0 00-9-9m9 9H3m9 9a9 9 0 01-9-9m9 9c1.657 0 3-4.03 3-9s-1.343-9-3-9m0 18c-1.657 0-3-4.03-3-9s1.343-9 3-9m-9 9a9 9 0 019-9"/></svg>
              <span class="truncate">www.msagues.com</span>
            </span>
          </div>
        </div>
