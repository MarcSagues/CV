...
@Component({
  ...
  template: `
    <section class="mb-16 animate-in" style="animation-delay: 0.05s">
      ...
      <div class="glass-card hover-card p-8 relative overflow-hidden bg-gradient-to-br from-white/90 to-primary-50/10 dark:from-zinc-900/90 dark:to-black transition-colors duration-300">
        <!-- Floating quote icon -->
        ...
        <p class="text-xl text-slate-700 dark:text-slate-300 leading-relaxed font-normal">
          Senior Software Engineer with 6+ years of experience building and evolving scalable web applications, with strong expertise in TypeScript and frontend architecture. Full-stack background with React, Node.js, PostgreSQL and AWS. Experienced leading major framework migrations, reusable component libraries and design systems — now progressing toward a Software Architect path, focused on maintainable architecture, scalability, performance and developer experience.
        </p>
        ...
        <div class="mt-8 flex flex-wrap gap-8">
          <div class="flex items-center gap-3 group">
            ...
            <div>
              <div class="text-2xl font-bold text-slate-900 dark:text-white border-none transition-colors duration-300 group-hover:text-primary-600 dark:group-hover:text-primary-400">6+ Years</div>
